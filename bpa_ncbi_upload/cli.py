...
def main():
    ...
    parser.add_argument('--ascp-url', required=True, help='ASCP target folder')
    parser.add_argument('--ascp-keyfile', required=True, help='ASCP private key')
    parser.add_argument('--tempdir', default='/tmp', help='Folder to upload to')
